...
const HEADER_MATCHERS: Record<CanonicalClientImportField, string[]> = {
  ...
  first_name: ["first name", "client first name", "fname", "given name"],
  last_name: ["last name", "client last name", "lname", "surname", "family name"],
  ...
  status: ["status", "client status", "active"],
};
